#if !MY_USE_MINLIB || defined(ANDROID)
...
#else
	__android_log_print(ANDROID_LOG_ERROR, "WaveMixer.cpp", "%s", "==================>TVPInitDirectSound not imp, implemented 20241220 sound good");
#endif
...
#else
	__android_log_print(ANDROID_LOG_ERROR, "WaveMixer.cpp", "%s", "==================>TVPUninitDirectSound not imp, implemented 20241220 sound good");
#endif
}
...
#else
	__android_log_print(ANDROID_LOG_ERROR, "WaveMixer.cpp", "%s", "==================>TVPCreateSoundBuffer not imp, implemented 20241220 sound good");
#endif
	//return NULL;
...
#endif //if defined(ANDROID) else //for linux
//===========================================================================================
...
{
	//throw;
	fprintf(stderr, "[WaveMixer.cpp] %s\n", "==================>TVPInitDirectSound not imp");
}
