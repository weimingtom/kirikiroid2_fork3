...
CPPFLAGS += -Icocos2d 
CPPFLAGS += -Icocos2d/cocos 
CPPFLAGS += -Icocos2d/cocos/platform 
#FIXME:
CPPFLAGS += -Icocos2d/cocos/platform/desktop 
CPPFLAGS += -Icocos2d/cocos/platform/linux 
CPPFLAGS += -Icocos2d/cocos/audio/include 
CPPFLAGS += -Icocos2d/cocos/editor-support
CPPFLAGS += -Icocos2d/deprecated 
CPPFLAGS += -Icocos2d/extensions 

CPPFLAGS += -Icocos2d/external 
CPPFLAGS += -Icocos2d/external/ConvertUTF 
CPPFLAGS += -Icocos2d/external/poly2tri 
CPPFLAGS += -Icocos2d/external/poly2tri/common 
CPPFLAGS += -Icocos2d/external/poly2tri/sweep 
CPPFLAGS += -Icocos2d/external/edtaa3func 
CPPFLAGS += -Icocos2d/external/xxtea 
CPPFLAGS += -Icocos2d/external/unzip 
CPPFLAGS += -Icocos2d/external/tinyxml2 
CPPFLAGS += -Icocos2d/external/xxhash 

CPPFLAGS += -Icocos2d/cocos/ui
CPPFLAGS += -Icocos2d/cocos/ui/UIEditBox
CPPFLAGS += -Icocos2d/cocos/editor-support/cocosbuilder
CPPFLAGS += -Icocos2d/cocos/editor-support/cocostudio
CPPFLAGS += -Icocos2d/cocos/editor-support/cocostudio/ActionTimeline
CPPFLAGS += -Icocos2d/cocos/editor-support/cocostudio/WidgetReader

#################
#kirikiroid2
CPPFLAGS += -I./Classes
CPPFLAGS += -I./cocos2d/extensions
CPPFLAGS += -I./cocos2d/cocos
CPPFLAGS += -I./cocos2d/cocos/editor-support
CPPFLAGS += -I./cocos2d/vendor/libgdiplus/src
CPPFLAGS += -I./cocos2d/vendor/google_breakpad/current/src
CPPFLAGS += -I./cocos2d/vendor/google_breakpad/current/src/common/android/include
...
LDFLAGS += -ljpeg 
LDFLAGS += -lpng 
LDFLAGS += -lGLESv2 -lEGL #FIXME:???why
...
#libcocos2d.a
OBJS += cocos2d/cocos/cocos2d.o

#2d
OBJS += cocos2d/cocos/2d/CCAction.o
OBJS += cocos2d/cocos/2d/CCActionCamera.o
OBJS += cocos2d/cocos/2d/CCActionCatmullRom.o
OBJS += cocos2d/cocos/2d/CCActionEase.o
OBJS += cocos2d/cocos/2d/CCActionGrid.o
OBJS += cocos2d/cocos/2d/CCActionGrid3D.o
OBJS += cocos2d/cocos/2d/CCActionInstant.o
OBJS += cocos2d/cocos/2d/CCActionInterval.o
OBJS += cocos2d/cocos/2d/CCActionManager.o
OBJS += cocos2d/cocos/2d/CCActionPageTurn3D.o
OBJS += cocos2d/cocos/2d/CCActionProgressTimer.o
OBJS += cocos2d/cocos/2d/CCActionTiledGrid.o
OBJS += cocos2d/cocos/2d/CCActionTween.o
OBJS += cocos2d/cocos/2d/CCAnimation.o
OBJS += cocos2d/cocos/2d/CCAnimationCache.o
OBJS += cocos2d/cocos/2d/CCAtlasNode.o
OBJS += cocos2d/cocos/2d/CCCamera.o
OBJS += cocos2d/cocos/2d/CCClippingNode.o
OBJS += cocos2d/cocos/2d/CCClippingRectangleNode.o
OBJS += cocos2d/cocos/2d/CCComponent.o
OBJS += cocos2d/cocos/2d/CCComponentContainer.o
OBJS += cocos2d/cocos/2d/CCDrawNode.o
OBJS += cocos2d/cocos/2d/CCDrawingPrimitives.o
OBJS += cocos2d/cocos/2d/CCFont.o
OBJS += cocos2d/cocos/2d/CCFontAtlas.o
OBJS += cocos2d/cocos/2d/CCFontAtlasCache.o
OBJS += cocos2d/cocos/2d/CCFontCharMap.o
OBJS += cocos2d/cocos/2d/CCFontFNT.o
OBJS += cocos2d/cocos/2d/CCFontFreeType.o
OBJS += cocos2d/cocos/2d/CCGLBufferedNode.o
OBJS += cocos2d/cocos/2d/CCGrabber.o
OBJS += cocos2d/cocos/2d/CCGrid.o
OBJS += cocos2d/cocos/2d/CCLabel.o
OBJS += cocos2d/cocos/2d/CCLabelAtlas.o
OBJS += cocos2d/cocos/2d/CCLabelBMFont.o
OBJS += cocos2d/cocos/2d/CCLabelTTF.o
OBJS += cocos2d/cocos/2d/CCLabelTextFormatter.o
OBJS += cocos2d/cocos/2d/CCLayer.o
OBJS += cocos2d/cocos/2d/CCLight.o
OBJS += cocos2d/cocos/2d/CCMenu.o
OBJS += cocos2d/cocos/2d/CCMenuItem.o
OBJS += cocos2d/cocos/2d/CCMotionStreak.o
OBJS += cocos2d/cocos/2d/CCNode.o
OBJS += cocos2d/cocos/2d/CCNodeGrid.o
OBJS += cocos2d/cocos/2d/CCParallaxNode.o
OBJS += cocos2d/cocos/2d/CCParticleBatchNode.o
OBJS += cocos2d/cocos/2d/CCParticleExamples.o
OBJS += cocos2d/cocos/2d/CCParticleSystem.o
OBJS += cocos2d/cocos/2d/CCParticleSystemQuad.o
OBJS += cocos2d/cocos/2d/CCProgressTimer.o
OBJS += cocos2d/cocos/2d/CCProtectedNode.o
OBJS += cocos2d/cocos/2d/CCRenderTexture.o
OBJS += cocos2d/cocos/2d/CCScene.o
OBJS += cocos2d/cocos/2d/CCSprite.o
OBJS += cocos2d/cocos/2d/CCSpriteBatchNode.o
OBJS += cocos2d/cocos/2d/CCSpriteFrame.o
OBJS += cocos2d/cocos/2d/CCSpriteFrameCache.o
#OBJS += cocos2d/cocos/2d/MarchingSquare.o
#OBJS += cocos2d/cocos/2d/SpritePolygon.o
#OBJS += cocos2d/cocos/2d/SpritePolygonCache.o
OBJS += cocos2d/cocos/2d/CCTMXLayer.o
OBJS += cocos2d/cocos/2d/CCFastTMXLayer.o
OBJS += cocos2d/cocos/2d/CCTMXObjectGroup.o
OBJS += cocos2d/cocos/2d/CCTMXTiledMap.o
OBJS += cocos2d/cocos/2d/CCFastTMXTiledMap.o
OBJS += cocos2d/cocos/2d/CCTMXXMLParser.o
OBJS += cocos2d/cocos/2d/CCTextFieldTTF.o
OBJS += cocos2d/cocos/2d/CCTileMapAtlas.o
OBJS += cocos2d/cocos/2d/CCTransition.o
OBJS += cocos2d/cocos/2d/CCTransitionPageTurn.o
OBJS += cocos2d/cocos/2d/CCTransitionProgress.o
OBJS += cocos2d/cocos/2d/CCTweenFunction.o

OBJS += cocos2d/cocos/2d/CCAutoPolygon.o
OBJS += cocos2d/cocos/2d/CCCameraBackgroundBrush.o

OBJS += cocos2d/cocos/3d/CCFrustum.o
OBJS += cocos2d/cocos/3d/CCPlane.o
OBJS += cocos2d/cocos/platform/CCGLView.o
OBJS += cocos2d/cocos/platform/CCFileUtils.o
OBJS += cocos2d/cocos/platform/CCSAXParser.o
OBJS += cocos2d/cocos/platform/CCThread.o
OBJS += cocos2d/cocos/platform/CCImage.o

OBJS += cocos2d/cocos/platform/linux/CCApplication-linux.o
OBJS += cocos2d/cocos/platform/linux/CCCommon-linux.o
OBJS += cocos2d/cocos/platform/linux/CCDevice-linux.o
OBJS += cocos2d/cocos/platform/linux/CCFileUtils-linux.o
OBJS += cocos2d/cocos/platform/linux/CCStdC-linux.o

OBJS += cocos2d/cocos/platform/desktop/CCGLViewImpl-desktop.o

#math
OBJS += cocos2d/cocos/math/CCAffineTransform.o
OBJS += cocos2d/cocos/math/CCGeometry.o
OBJS += cocos2d/cocos/math/CCVertex.o
OBJS += cocos2d/cocos/math/MathUtil.o
OBJS += cocos2d/cocos/math/Mat4.o
OBJS += cocos2d/cocos/math/Quaternion.o
OBJS += cocos2d/cocos/math/TransformUtils.o
OBJS += cocos2d/cocos/math/Vec2.o
OBJS += cocos2d/cocos/math/Vec3.o
OBJS += cocos2d/cocos/math/Vec4.o

#base
OBJS += cocos2d/cocos/base/CCAsyncTaskPool.o
OBJS += cocos2d/cocos/base/CCAutoreleasePool.o
OBJS += cocos2d/cocos/base/CCConfiguration.o
OBJS += cocos2d/cocos/base/CCConsole.o
OBJS += cocos2d/cocos/base/CCData.o
OBJS += cocos2d/cocos/base/CCDataVisitor.o
OBJS += cocos2d/cocos/base/CCDirector.o
OBJS += cocos2d/cocos/base/CCEvent.o
OBJS += cocos2d/cocos/base/CCEventAcceleration.o
OBJS += cocos2d/cocos/base/CCEventCustom.o
OBJS += cocos2d/cocos/base/CCEventDispatcher.o
OBJS += cocos2d/cocos/base/CCEventFocus.o
OBJS += cocos2d/cocos/base/CCEventKeyboard.o
OBJS += cocos2d/cocos/base/CCEventController.o
OBJS += cocos2d/cocos/base/CCEventListener.o
OBJS += cocos2d/cocos/base/CCEventListenerController.o
OBJS += cocos2d/cocos/base/CCEventListenerAcceleration.o
OBJS += cocos2d/cocos/base/CCEventListenerCustom.o
OBJS += cocos2d/cocos/base/CCEventListenerFocus.o
OBJS += cocos2d/cocos/base/CCEventListenerKeyboard.o
OBJS += cocos2d/cocos/base/CCEventListenerMouse.o
OBJS += cocos2d/cocos/base/CCEventListenerTouch.o
OBJS += cocos2d/cocos/base/CCEventMouse.o
OBJS += cocos2d/cocos/base/CCEventTouch.o
OBJS += cocos2d/cocos/base/CCIMEDispatcher.o
OBJS += cocos2d/cocos/base/CCNS.o
OBJS += cocos2d/cocos/base/CCProfiling.o
OBJS += cocos2d/cocos/base/ccRandom.o
OBJS += cocos2d/cocos/base/CCRef.o
OBJS += cocos2d/cocos/base/CCScheduler.o
OBJS += cocos2d/cocos/base/CCScriptSupport.o
OBJS += cocos2d/cocos/base/CCTouch.o
OBJS += cocos2d/cocos/base/CCUserDefault.o
#OBJS += cocos2d/cocos/base/CCUserDefault-android.o
OBJS += cocos2d/cocos/base/CCValue.o
OBJS += cocos2d/cocos/base/TGAlib.o
OBJS += cocos2d/cocos/base/ZipUtils.o
OBJS += cocos2d/cocos/base/atitc.o
OBJS += cocos2d/cocos/base/base64.o
OBJS += cocos2d/cocos/base/ccCArray.o
OBJS += cocos2d/cocos/base/ccFPSImages.o
OBJS += cocos2d/cocos/base/ccTypes.o
OBJS += cocos2d/cocos/base/ccUTF8.o
OBJS += cocos2d/cocos/base/ccUtils.o
OBJS += cocos2d/cocos/base/etc1.o
OBJS += cocos2d/cocos/base/pvr.o
OBJS += cocos2d/cocos/base/s3tc.o
OBJS += cocos2d/cocos/base/CCController.o
#OBJS += cocos2d/cocos/base/CCController-android.o
OBJS += cocos2d/cocos/base/allocator/CCAllocatorDiagnostics.o
OBJS += cocos2d/cocos/base/allocator/CCAllocatorGlobal.o
OBJS += cocos2d/cocos/base/allocator/CCAllocatorGlobalNewDelete.o
OBJS += cocos2d/cocos/base/ObjectFactory.o

OBJS += cocos2d/cocos/base/CCController-linux-win32.o
OBJS += cocos2d/cocos/base/CCNinePatchImageParser.o
OBJS += cocos2d/cocos/base/CCProperties.o
OBJS += cocos2d/cocos/base/CCUserDefault-winrt.o
OBJS += cocos2d/cocos/base/CCStencilStateManager.o

#renderer
OBJS += cocos2d/cocos/renderer/CCBatchCommand.o
OBJS += cocos2d/cocos/renderer/CCCustomCommand.o
OBJS += cocos2d/cocos/renderer/CCGLProgram.o
OBJS += cocos2d/cocos/renderer/CCGLProgramCache.o
OBJS += cocos2d/cocos/renderer/CCGLProgramState.o
OBJS += cocos2d/cocos/renderer/CCGLProgramStateCache.o
OBJS += cocos2d/cocos/renderer/CCGroupCommand.o
OBJS += cocos2d/cocos/renderer/CCQuadCommand.o
OBJS += cocos2d/cocos/renderer/CCMeshCommand.o
OBJS += cocos2d/cocos/renderer/CCRenderCommand.o
OBJS += cocos2d/cocos/renderer/CCRenderer.o
OBJS += cocos2d/cocos/renderer/CCTexture2D.o
OBJS += cocos2d/cocos/renderer/CCTextureAtlas.o
OBJS += cocos2d/cocos/renderer/CCTextureCache.o
OBJS += cocos2d/cocos/renderer/ccGLStateCache.o
OBJS += cocos2d/cocos/renderer/ccShaders.o
OBJS += cocos2d/cocos/renderer/CCVertexIndexBuffer.o
OBJS += cocos2d/cocos/renderer/CCVertexIndexData.o
OBJS += cocos2d/cocos/renderer/CCPrimitive.o
OBJS += cocos2d/cocos/renderer/CCPrimitiveCommand.o
OBJS += cocos2d/cocos/renderer/CCTrianglesCommand.o

OBJS += cocos2d/cocos/renderer/CCFrameBuffer.o
OBJS += cocos2d/cocos/renderer/CCMaterial.o
OBJS += cocos2d/cocos/renderer/CCPass.o
OBJS += cocos2d/cocos/renderer/CCRenderState.o
OBJS += cocos2d/cocos/renderer/CCTechnique.o
OBJS += cocos2d/cocos/renderer/CCTextureCube.o
OBJS += cocos2d/cocos/renderer/CCVertexAttribBinding.o

#deprecated
OBJS += cocos2d/cocos/deprecated/CCArray.o
OBJS += cocos2d/cocos/deprecated/CCSet.o
OBJS += cocos2d/cocos/deprecated/CCString.o
OBJS += cocos2d/cocos/deprecated/CCDictionary.o
OBJS += cocos2d/cocos/deprecated/CCDeprecated.o
OBJS += cocos2d/cocos/deprecated/CCNotificationCenter.o

OBJS += cocos2d/external/ConvertUTF/ConvertUTFWrapper.o
OBJS += cocos2d/external/ConvertUTF/ConvertUTF.o

OBJS += cocos2d/external/edtaa3func/edtaa3func.o

OBJS += cocos2d/external/poly2tri/common/shapes.o
OBJS += cocos2d/external/poly2tri/sweep/advancing_front.o
OBJS += cocos2d/external/poly2tri/sweep/cdt.o
OBJS += cocos2d/external/poly2tri/sweep/sweep_context.o
OBJS += cocos2d/external/poly2tri/sweep/sweep.o

#LDFLAGS += ../../lib/libtinyxml2.a 
OBJS += cocos2d/external/tinyxml2/tinyxml2.o

#LDFLAGS += ../../lib/libunzip.a 
OBJS += cocos2d/external/unzip/ioapi_mem.o
OBJS += cocos2d/external/unzip/ioapi.o
OBJS += cocos2d/external/unzip/unzip.o

#LDFLAGS += ../../lib/libxxhash.a 
OBJS += cocos2d/external/xxhash/xxhash.o

OBJS += cocos2d/external/md5/md5.o

OBJS += cocos2d/external/clipper/clipper.o

#ui
OBJS += cocos2d/cocos/ui/UIWidget.o
OBJS += cocos2d/cocos/ui/UILayout.o
OBJS += cocos2d/cocos/ui/UILayoutParameter.o
OBJS += cocos2d/cocos/ui/UILayoutManager.o
OBJS += cocos2d/cocos/ui/CocosGUI.o
OBJS += cocos2d/cocos/ui/UIHelper.o
OBJS += cocos2d/cocos/ui/UIListView.o
OBJS += cocos2d/cocos/ui/UIPageView.o
OBJS += cocos2d/cocos/ui/UIScrollView.o
OBJS += cocos2d/cocos/ui/UIButton.o
OBJS += cocos2d/cocos/ui/UICheckBox.o
OBJS += cocos2d/cocos/ui/UIImageView.o
OBJS += cocos2d/cocos/ui/UIText.o
OBJS += cocos2d/cocos/ui/UITextAtlas.o
OBJS += cocos2d/cocos/ui/UITextBMFont.o
OBJS += cocos2d/cocos/ui/UILoadingBar.o
OBJS += cocos2d/cocos/ui/UISlider.o
OBJS += cocos2d/cocos/ui/UITextField.o
OBJS += cocos2d/cocos/ui/UIRichText.o
OBJS += cocos2d/cocos/ui/UIHBox.o
OBJS += cocos2d/cocos/ui/UIVBox.o
OBJS += cocos2d/cocos/ui/UIRelativeBox.o
OBJS += cocos2d/cocos/ui/UIVideoPlayer-android.o
OBJS += cocos2d/cocos/ui/UIDeprecated.o
OBJS += cocos2d/cocos/ui/UIScale9Sprite.o
OBJS += cocos2d/cocos/ui/UIWebView.o
OBJS += cocos2d/cocos/ui/UIWebViewImpl-android.o
OBJS += cocos2d/cocos/ui/UIEditBox/UIEditBox.o
OBJS += cocos2d/cocos/ui/UIEditBox/UIEditBoxImpl-android.o
OBJS += cocos2d/cocos/ui/UILayoutComponent.o

OBJS += cocos2d/cocos/ui/UIAbstractCheckButton.o
OBJS += cocos2d/cocos/ui/UIPageViewIndicator.o
OBJS += cocos2d/cocos/ui/UIRadioButton.o
OBJS += cocos2d/cocos/ui/UIScrollViewBar.o
OBJS += cocos2d/cocos/ui/UITabControl.o
OBJS += cocos2d/cocos/ui/UIVideoPlayer-tizen.o
#OBJS += cocos2d/cocos/ui/UIWebViewImpl-tizen.o

#cocosbuilder
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBAnimationManager.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBFileLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBKeyframe.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBReader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBSequence.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCBSequenceProperty.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCControlButtonLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCControlLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCLabelBMFontLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCLabelTTFLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCLayerColorLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCLayerGradientLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCLayerLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCMenuItemImageLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCMenuItemLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCNode+CCBRelativePositioning.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCNodeLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCNodeLoaderLibrary.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCParticleSystemQuadLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCScale9SpriteLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCScrollViewLoader.o
OBJS += cocos2d/cocos/editor-support/cocosbuilder/CCSpriteLoader.o

#cocosstudio
OBJS += cocos2d/cocos/editor-support/cocostudio/CCActionFrame.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCActionFrameEasing.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCActionManagerEx.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCActionNode.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCActionObject.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCArmature.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCBone.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCArmatureAnimation.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCProcessBase.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCTween.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCDatas.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCBatchNode.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCDecorativeDisplay.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCDisplayFactory.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCDisplayManager.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCSkin.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCColliderDetector.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCArmatureDataManager.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCArmatureDefine.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCDataReaderHelper.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCSpriteFrameCacheHelper.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCTransformHelp.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCUtilMath.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCComAttribute.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCComAudio.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCComController.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCComRender.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCInputDelegate.o
OBJS += cocos2d/cocos/editor-support/cocostudio/DictionaryHelper.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCSGUIReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CCSSceneReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/TriggerBase.o
OBJS += cocos2d/cocos/editor-support/cocostudio/TriggerMng.o
OBJS += cocos2d/cocos/editor-support/cocostudio/TriggerObj.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CocoLoader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/NodeReader/NodeReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/SingleNodeReader/SingleNodeReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/SpriteReader/SpriteReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ParticleReader/ParticleReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/GameMapReader/GameMapReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ProjectNodeReader/ProjectNodeReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ComAudioReader/ComAudioReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/WidgetReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ButtonReader/ButtonReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/CheckBoxReader/CheckBoxReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ImageViewReader/ImageViewReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/LayoutReader/LayoutReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ListViewReader/ListViewReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/LoadingBarReader/LoadingBarReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/PageViewReader/PageViewReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ScrollViewReader/ScrollViewReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/SliderReader/SliderReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/TextAtlasReader/TextAtlasReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/TextBMFontReader/TextBMFontReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/TextFieldReader/TextFieldReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/TextReader/TextReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/Node3DReader/Node3DReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/Sprite3DReader/Sprite3DReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/UserCameraReader/UserCameraReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCActionTimelineCache.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCFrame.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCTimeLine.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCActionTimeline.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCActionTimelineNode.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CSLoader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/FlatBuffersSerialize.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetCallBackHandlerProtocol.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/ArmatureNodeReader/ArmatureNodeReader.o
#OBJS += cocos2d/cocos/editor-support/cocostudio/CCObjectExtensionData.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CocoStudio.o

OBJS += cocos2d/cocos/editor-support/cocostudio/CCComExtensionData.o
OBJS += cocos2d/cocos/editor-support/cocostudio/CocosStudioExtension.o
OBJS += cocos2d/cocos/editor-support/cocostudio/LocalizationManager.o
#OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/Particle3DReader/Particle3DReader.o #MY_USE_PARTICLE3D
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/GameNode3DReader/GameNode3DReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/Light3DReader/Light3DReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/TabControlReader/TabControlReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/SkeletonReader/BoneNodeReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/WidgetReader/SkeletonReader/SkeletonNodeReader.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCBoneNode.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCSkeletonNode.o
OBJS += cocos2d/cocos/editor-support/cocostudio/ActionTimeline/CCSkinNode.o



#3d
OBJS += cocos2d/cocos/3d/CCRay.o
OBJS += cocos2d/cocos/3d/CCAABB.o
OBJS += cocos2d/cocos/3d/CCOBB.o
OBJS += cocos2d/cocos/3d/CCAnimate3D.o
OBJS += cocos2d/cocos/3d/CCAnimation3D.o
OBJS += cocos2d/cocos/3d/CCAttachNode.o
OBJS += cocos2d/cocos/3d/CCBillBoard.o
OBJS += cocos2d/cocos/3d/CCBundle3D.o
OBJS += cocos2d/cocos/3d/CCBundleReader.o
OBJS += cocos2d/cocos/3d/CCMesh.o
OBJS += cocos2d/cocos/3d/CCMeshSkin.o
OBJS += cocos2d/cocos/3d/CCMeshVertexIndexData.o
OBJS += cocos2d/cocos/3d/CCSprite3DMaterial.o
OBJS += cocos2d/cocos/3d/CCObjLoader.o
OBJS += cocos2d/cocos/3d/CCSkeleton3D.o
OBJS += cocos2d/cocos/3d/CCSprite3D.o
OBJS += cocos2d/cocos/3d/CCTerrain.o
OBJS += cocos2d/cocos/3d/CCSkybox.o
#OBJS += cocos2d/cocos/3d/CCTextureCube.o

OBJS += cocos2d/cocos/3d/CCMotionStreak3D.o

#extensions ScrollView
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControl.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlButton.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlColourPicker.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlHuePicker.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlPotentiometer.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlSaturationBrightnessPicker.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlSlider.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlStepper.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlSwitch.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCControlUtils.o
OBJS += cocos2d/extensions/GUI/CCControlExtension/CCInvocation.o
OBJS += cocos2d/extensions/GUI/CCScrollView/CCScrollView.o
OBJS += cocos2d/extensions/GUI/CCScrollView/CCTableView.o
OBJS += cocos2d/extensions/GUI/CCScrollView/CCTableViewCell.o
...
KIRIKIROID2_OBJS += ./src/core/environ/linux_special/LinuxCommon.o #FIXME:added
